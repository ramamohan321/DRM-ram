...
<head>
    ...
    <link rel="stylesheet" href="styles\view-review-pts.css">
</head>
<!-- Body Section -->

<body>
    <script src="script\view-review-pts.js"></script>
    ...
    <div class="main">
        <div class="section">
            ...
            <div class="navbar">
                ...
                <h1 class="navbar-heading">View Rewiew Points
        ...
        <div class="sidebar">
            ...
            <ul>
                ...
                <li>
                    <a href="view-review-pts.php?<?php echo time(); ?>" class="active">
